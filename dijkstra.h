...
void displayTwoFile(Graph *g, int origin, int destination, const vector<int>& nodesToAvoid,const vector<pair<int, int>>& edgesToAvoid, int includeVertex, ofstream &outputFile);
